...
export default function Card({ icon, title, description, delay = 0 }: Props) {
  return (
    <ScrollReveal delay={delay}>
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-7 hover:-translate-y-1 hover:shadow-xl transition-all h-full">
        {icon && (
